...
<center>
<?php
echo '<font face="Bungee" size="5">_human error_</font>
</center>
...
function author() {
    echo "<center><br>_human error_<br><a href='https://youtu.be/kmvHFzIF1y8?si=cVH00ZnsGA4szU_2' target='_blank'>error system</a></center>";
    die();
}
